...
HPWH::MODELS mapStringToPreset(string modelName) {
	...
	if(modelName == "Voltex60" || modelName == "AOSmithPHPT60") {
		hpwhModel = HPWH::MODELS::AOSmithPHPT60;
	}
	else if (modelName == "Voltex80" || modelName == "AOSmith80") {
		hpwhModel = HPWH::MODELS::AOSmithPHPT80;
	}
	else if (modelName == "GEred" || modelName == "GE") {
		hpwhModel = HPWH::MODELS::GE2012;
	}
	else if (modelName == "SandenGAU" || modelName == "Sanden80" || modelName == "SandenGen3") {
		hpwhModel = HPWH::MODELS::Sanden80;
	}
	else if (modelName == "Sanden120") {
		hpwhModel = HPWH::MODELS::Sanden120;
	}
	else if (modelName == "SandenGES" || modelName == "Sanden40") {
		hpwhModel = HPWH::MODELS::Sanden40;
	}
	else if (modelName == "AOSmithHPTU50") {
		hpwhModel = HPWH::MODELS::AOSmithHPTU50;
	}
	else if (modelName == "AOSmithHPTU66") {
		hpwhModel = HPWH::MODELS::AOSmithHPTU66;
	}
	else if (modelName == "AOSmithHPTU80") {
		hpwhModel = HPWH::MODELS::AOSmithHPTU80;
	}
	else if (modelName == "AOSmithHPTS50") {
		hpwhModel = HPWH::MODELS::AOSmithHPTS50;
	}
	else if (modelName == "AOSmithHPTS66") {
		hpwhModel = HPWH::MODELS::AOSmithHPTS66;
	}
	else if (modelName == "AOSmithHPTS80") {
		hpwhModel = HPWH::MODELS::AOSmithHPTS80;
	}
	else if (modelName == "AOSmithHPTU80DR") {
		hpwhModel = HPWH::MODELS::AOSmithHPTU80_DR;
	}
	else if (modelName == "GE502014STDMode" || modelName == "GE2014STDMode") {
		hpwhModel = HPWH::MODELS::GE2014STDMode;
	}
	else if (modelName == "GE502014" || modelName == "GE2014") {
		hpwhModel = HPWH::MODELS::GE2014;
	}
	else if (modelName == "GE802014") {
		hpwhModel = HPWH::MODELS::GE2014_80DR;
	}
	else if (modelName == "RheemHB50") {
		hpwhModel = HPWH::MODELS::RheemHB50;
	}
	else if (modelName == "Stiebel220e" || modelName == "Stiebel220E") {
		hpwhModel = HPWH::MODELS::Stiebel220E;
	}
	else if (modelName == "Generic1") {
		hpwhModel = HPWH::MODELS::Generic1;
	}
	else if (modelName == "Generic2") {
		hpwhModel = HPWH::MODELS::Generic2;
	}
	else if (modelName == "Generic3") {
		hpwhModel = HPWH::MODELS::Generic3;
	}
	else if (modelName == "custom") {
		hpwhModel = HPWH::MODELS::CustomFile;
	}
	else if (modelName == "restankRealistic") {
		hpwhModel = HPWH::MODELS::restankRealistic;
	}
	else if (modelName == "StorageTank") {
		hpwhModel = HPWH::MODELS::StorageTank;
	}
	else if (modelName == "BWC2020_65") {
		hpwhModel = HPWH::MODELS::BWC2020_65;
	}
	// New Rheems
	else if (modelName == "Rheem2020Prem40") {
		hpwhModel = HPWH::MODELS::Rheem2020Prem40;
	}
	else if (modelName == "Rheem2020Prem50") {
		hpwhModel = HPWH::MODELS::Rheem2020Prem50;
	}
	else if (modelName == "Rheem2020Prem65") {
		hpwhModel = HPWH::MODELS::Rheem2020Prem65;
	}
	else if (modelName == "Rheem2020Prem80") {
		hpwhModel = HPWH::MODELS::Rheem2020Prem80;
	}
	else if (modelName == "Rheem2020Build40") {
		hpwhModel = HPWH::MODELS::Rheem2020Build40;
	}
	else if (modelName == "Rheem2020Build50") {
		hpwhModel = HPWH::MODELS::Rheem2020Build50;
	}
	else if (modelName == "Rheem2020Build65") {
		hpwhModel = HPWH::MODELS::Rheem2020Build65;
	}
	else if (modelName == "Rheem2020Build80") {
		hpwhModel = HPWH::MODELS::Rheem2020Build80;
	}
	else if (modelName == "RheemPlugInDedicated40") {
		hpwhModel = HPWH::MODELS::RheemPlugInDedicated40;
	}
	else if (modelName == "RheemPlugInDedicated50") {
		hpwhModel = HPWH::MODELS::RheemPlugInDedicated50;
	}
	else if (modelName == "RheemPlugInShared40") {
		hpwhModel = HPWH::MODELS::RheemPlugInShared40;
	}
	else if (modelName == "RheemPlugInShared50") {
		hpwhModel = HPWH::MODELS::RheemPlugInShared50;
	}
	else if (modelName == "RheemPlugInShared65") {
		hpwhModel = HPWH::MODELS::RheemPlugInShared65;
	}
	else if (modelName == "RheemPlugInShared80") {
		hpwhModel = HPWH::MODELS::RheemPlugInShared80;
	}
	// Large HPWH's
	else if (modelName == "AOSmithCAHP120") {
		hpwhModel = HPWH::MODELS::AOSmithCAHP120;
	}
	else if (modelName == "ColmacCxV_5_SP") {
		hpwhModel = HPWH::MODELS::ColmacCxV_5_SP;
	}
	else if (modelName == "ColmacCxA_10_SP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_10_SP;
	}
	else if (modelName == "ColmacCxA_15_SP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_15_SP;
	}
	else if (modelName == "ColmacCxA_20_SP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_20_SP;
	}
	else if (modelName == "ColmacCxA_25_SP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_25_SP;
	}
	else if (modelName == "ColmacCxA_30_SP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_30_SP;
	}

	else if (modelName == "ColmacCxV_5_MP") {
		hpwhModel = HPWH::MODELS::ColmacCxV_5_MP;
	}
	else if (modelName == "ColmacCxA_10_MP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_10_MP;
	}
	else if (modelName == "ColmacCxA_15_MP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_15_MP;
	}
	else if (modelName == "ColmacCxA_20_MP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_20_MP;
	}
	else if (modelName == "ColmacCxA_25_MP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_25_MP;
	}
	else if (modelName == "ColmacCxA_30_MP") {
		hpwhModel = HPWH::MODELS::ColmacCxA_30_MP;
	}

	else if (modelName == "RheemHPHD60") {
		hpwhModel = HPWH::MODELS::RHEEM_HPHD60VNU_201_MP;
	}
	else if (modelName == "RheemHPHD135") {
		hpwhModel = HPWH::MODELS::RHEEM_HPHD135VNU_483_MP;
	}
	//Nyle Single pass models
	else if (modelName == "NyleC25A_SP") {
		hpwhModel = HPWH::MODELS::NyleC25A_SP;
	}
	else if (modelName == "NyleC60A_SP") {
		hpwhModel = HPWH::MODELS::NyleC60A_SP;
	}
	else if (modelName == "NyleC90A_SP") {
		hpwhModel = HPWH::MODELS::NyleC90A_SP;
	}
	else if (modelName == "NyleC185A_SP") {
		hpwhModel = HPWH::MODELS::NyleC185A_SP;
	}
	else if (modelName == "NyleC250A_SP") {
		hpwhModel = HPWH::MODELS::NyleC250A_SP;
	}
	else if (modelName == "NyleC60A_C_SP") {
		hpwhModel = HPWH::MODELS::NyleC60A_C_SP;
	}
	else if (modelName == "NyleC90A_C_SP") {
		hpwhModel = HPWH::MODELS::NyleC90A_C_SP;
	}
	else if (modelName == "NyleC185A_C_SP") {
		hpwhModel = HPWH::MODELS::NyleC185A_C_SP;
	}
	else if (modelName == "NyleC250A_C_SP") {
		hpwhModel = HPWH::MODELS::NyleC250A_C_SP;
	}
	// Nyle MP models
	else if (modelName == "NyleC60A_MP") {
		hpwhModel = HPWH::MODELS::NyleC60A_MP;
	}
	else if (modelName == "NyleC90A_MP") {
		hpwhModel = HPWH::MODELS::NyleC90A_MP;
	}
	else if (modelName == "NyleC125A_MP") {
		hpwhModel = HPWH::MODELS::NyleC125A_MP;
	}
	else if (modelName == "NyleC185A_MP") {
		hpwhModel = HPWH::MODELS::NyleC185A_MP;
	}
	else if (modelName == "NyleC250A_MP") {
		hpwhModel = HPWH::MODELS::NyleC250A_MP;
	}
	else if (modelName == "NyleC60A_C_MP") {
		hpwhModel = HPWH::MODELS::NyleC60A_C_MP;
	}
	else if (modelName == "NyleC90A_C_MP") {
		hpwhModel = HPWH::MODELS::NyleC90A_C_MP;
	}
	else if (modelName == "NyleC125A_C_MP") {
		hpwhModel = HPWH::MODELS::NyleC125A_C_MP;
	}
	else if (modelName == "NyleC185A_C_MP") {
		hpwhModel = HPWH::MODELS::NyleC185A_C_MP;
	}
	else if (modelName == "NyleC250A_C_MP") {
		hpwhModel = HPWH::MODELS::NyleC250A_C_MP;
	}
	else if (modelName == "QAHV_N136TAU_HPB_SP") {
		hpwhModel = HPWH::MODELS::MITSUBISHI_QAHV_N136TAU_HPB_SP;
	}
	// Stack in a couple scalable models
	else if (modelName == "TamScalable_SP") {
		hpwhModel = HPWH::MODELS::TamScalable_SP;
	}
		...
		hpwhModel = HPWH::MODELS::Scalable_MP;
	}
	else if (modelName == "AWHSTier3Generic40") {
		hpwhModel = HPWH::MODELS::AWHSTier3Generic40;
	}
	else if (modelName == "AWHSTier3Generic50") {
		hpwhModel = HPWH::MODELS::AWHSTier3Generic50;
	}
	else if (modelName == "AWHSTier3Generic65") {
		hpwhModel = HPWH::MODELS::AWHSTier3Generic65;
	}
	else if (modelName == "AWHSTier3Generic80") {
		hpwhModel = HPWH::MODELS::AWHSTier3Generic80;
	}
	else { 
		hpwhModel = HPWH::MODELS::basicIntegrated;
