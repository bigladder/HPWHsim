...
TEST_F(PerformanceMapTest, ColmacCxA_15_SP)
{
    ...
    double capacityData_kW = 56.340310395649922;
    ...
    waterTempF = 40.;
    setpointF = 150.;
    capacityData_kW = 47.141784335139675;
    ...
    waterTempF = 40.;
    setpointF = 125.;
    capacityData_kW = 37.132107925768295;
...
TEST_F(PerformanceMapTest, ColmacCxA_30_SP)
{
    ...
    double waterTempF = 125.;
    double setpointF = 150.;
    double capacityData_kW = 108.89363410213893;
    ...
    waterTempF = 40.;
    setpointF = 150.;
    capacityData_kW = 90.987730901917516;
    ...
    waterTempF = 40.;
    setpointF = 125.;
    capacityData_kW = 73.493657188039691;
...
TEST_F(PerformanceMapTest, ColmacCxV_5_MP)
{
    ...
    checkPoint = {10.0, 102.0, 10.039598621171924};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {70.0, 74.0, 19.158555609475041};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {70.0, 116.0, 19.086101729364142};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 116.0, 24.547042599653881};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
}
...
TEST_F(PerformanceMapTest, ColmacCxA_10_MP)
{
    ...
    checkPoint = {80.0, 66.0, 37.918829622964438};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {80.0, 114.0, 35.586716261825138};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 66.0, 46.804577248784113};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 114.0, 43.65229951755483};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
}
...
TEST_F(PerformanceMapTest, ColmacCxA_15_MP)
{
    ...
    checkPoint = {80.0, 66.0, 52.241378348523831};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {80.0, 114.0, 45.876699657377493};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 66.0, 67.034256759416493};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 114.0, 56.899528358362055};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
}
...
TEST_F(PerformanceMapTest, ColmacCxA_20_MP)
{
    ...
    checkPoint = {80.0, 66.0, 73.54505832};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {80.0, 114.0, 68.910474424};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 66.0, 90.411596896998};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 114.0, 85.017892};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
}
...
TEST_F(PerformanceMapTest, ColmacCxA_25_MP)
{
    ...
    checkPoint = {80.0, 66.0, 85.24715872738};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {80.0, 114.0, 80.40802493};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 66.0, 103.527038185};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 114.0, 98.014976754};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
}
...
TEST_F(PerformanceMapTest, ColmacCxA_30_MP)
{
    ...
    checkPoint = {80.0, 66.0, 94.4846558};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {80.0, 114.0, 91.0269539};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 66.0, 112.6640600};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));

    checkPoint = {100.0, 114.0, 109.4324977};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
}
...
TEST_F(PerformanceMapTest, RheemHPHD60)
{
    ...
    // test some points outside of defrost ////////////////
    checkPoint = {66.6666666, 60.0, 16.643631959};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
    checkPoint = {66.6666666, 120.0, 16.4917432};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
    checkPoint = {88.3333333, 80.0, 20.4717656};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
...
TEST_F(PerformanceMapTest, RheemHPHD135)
{
    ...
    // test some points outside of defrost ////////////////
    checkPoint = {66.6666666, 80.0, 38.8245548};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
    checkPoint = {66.6666666, 140.0, 35.07709568};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
    checkPoint = {88.3333333, 140.0, 43.220292877};
    EXPECT_NEAR_REL(checkPoint.outputBTUH, getCapacityMP_F_KW(hpwh, checkPoint));
...
TEST_F(PerformanceMapTest, QAHV_N136TAU_HPB_SP)
{
    ...
    // test
    checkPoint = {-13.0, 140.0, 41.0, 66325.108898033766};
    ...
    // test
    checkPoint = {-13.0, 176.0, 41.0, 66325.108898033766};
    EXPECT_ANY_THROW(
    ...
    // test
    checkPoint = {-13.0, 176.0, 84.2, 56115.382784264584};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));

    // test
    checkPoint = {14.0, 176.0, 84.2, 93810.202867366301};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));

    // test
    checkPoint = {42.8, 140.0, 41.0, 137461.32325649555};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));

    // test
    checkPoint = {50.0, 140.0, 41.0, 139793.19509455137};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));

    // test
    checkPoint = {50.0, 176.0, 84.2, 138116.39502241145};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));
    // test
    checkPoint = {60.8, 158.0, 84.2, 138637.99658115057};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));

    // test
    checkPoint = {71.6, 158.0, 48.2, 138509.3241703508};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));

    // test constant with setpoint between 140 and 158
    checkPoint = {71.6, 149.0, 48.2, 138509.3241703508};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));

    // test
    checkPoint = {82.4, 176.0, 41.0, 137873.72900162858};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));

    // test
    checkPoint = {104.0, 140.0, 62.6, 137646.44503821834};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));
    // test
    checkPoint = {104.0, 158.0, 62.6, 137646.44503821834};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));
    // test
    checkPoint = {104.0, 176.0, 84.2, 137324.3889832542};
    EXPECT_NEAR_REL(checkPoint.outputBTUH,
                    getCapacitySP_F_BTUHR(hpwh, checkPoint, tInOffsetQAHV_dF, tOutOffsetQAHV_dF));
}
...
TEST_F(PerformanceMapTest, Sanden120)
{
    ...
    // nominal
    checkPoint = {60, 149.0, 41.0, 15000.234347856};
    ...
    checkPoint = {60, 125.0, 41.0, 15000.234347856};
    outputBTUH = hpwh.getCompressorCapacity(
        checkPoint.tairF, checkPoint.tinF, checkPoint.toutF, HPWH::UNITS_BTUperHr, HPWH::UNITS_F);
    EXPECT_NEAR_REL(checkPoint.outputBTUH, outputBTUH);

    // tests fails when output high
    checkPoint = {60, 200, 41.0, 15000.234347856};
...
TEST_F(PerformanceMapTest, ReloadFromDataModel_CWHS)
{
    HPWH hpwh;
    {
        ...
        // using polynomial map
        checkPoint = {45., 40., 135, 45.300055153357782};
        double output_kW = hpwh.getCompressorCapacity(checkPoint.externalT_F,
                                                      checkPoint.condenserT_F,
                                                      checkPoint.outletT_F,
                                                      HPWH::UNITS_KW,
    ...
    }
    {
        ...
        // using polynomial map
        checkPoint = {45., 40., 135, 44.187140235312974};
        double output_kW = hpwh.getCompressorCapacity(checkPoint.externalT_F,
                                                      checkPoint.condenserT_F,
                                                      checkPoint.outletT_F,
                                                      HPWH::UNITS_KW,
