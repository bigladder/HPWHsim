...
TEST(ResistanceFunctionsTest, getSetResistanceErrors)
{
    ...
    EXPECT_NO_THROW(hpwh.initResistanceTank(
        {100., Units::L}, {0.95, Units::m2C_per_W}, {0., Units::W}, lowerElementPower))
...
TEST(ResistanceFunctionsTest, commercialTankInitErrors)
{
    ...
    EXPECT_ANY_THROW(hpwh.initResistanceTankGeneric({800., Units::L},
                                                    {10., Units::m2C_per_W},
                                                    HPWH::P0(),
                                                    HPWH::P0())); // Check needs one element
}
...
TEST(ResistanceFunctionsTest, commercialTankErrorsWithBottomElement)
{
    ...
    hpwh.initResistanceTankGeneric(
        {800., Units::L}, {10., Units::m2C_per_W}, HPWH::P0(), 1000. * elementPower);
...
TEST(ResistanceFunctionsTest, commercialTankErrorsWithTopElement)
{
    ...
    HPWH hpwh;
    hpwh.initResistanceTankGeneric(
        {800., Units::L}, {10., Units::ft2hF_per_Btu}, elementPower, HPWH::P0());
