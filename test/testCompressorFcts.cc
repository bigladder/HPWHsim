...
int main(int, char*)
{
	...
	const string models [length] = {"AOSmithHPTU50", "Stiebel220e","AOSmithCAHP120", \
						...
						"QAHV_N136TAU_HPB_SP"};
	const int hasComp[length] = { true, true, true, true, true, true, true, false, false, true, true, true, true, true };
	const int coilConfig[length] = { 1, 1, 1, 2, 2, 2, 2, HPWH::HPWH_ABORT, HPWH::HPWH_ABORT, 2, 2, 2, 2, 2}; // 1 Wrapped 2 External
 	const int heatCycle[length] = { true, true, true, false, false, false, false, HPWH::HPWH_ABORT, HPWH::HPWH_ABORT, true, true, true, true, false }; //true single, false singlepass
	const int isExtMP[length] = { false, false, false, false, false, false, false, HPWH::HPWH_ABORT, HPWH::HPWH_ABORT, true, true, true, true, false }; 
	...
	const double maxStpt[length] = { HPWH::MAXOUTLET_R134A, HPWH::MAXOUTLET_R134A,HPWH::MAXOUTLET_R134A,
									 ...
									 HPWH::MAXOUTLET_R134A, HPWH::MAXOUTLET_R134A, 160., 160., F_TO_C(176.1) }; //F
