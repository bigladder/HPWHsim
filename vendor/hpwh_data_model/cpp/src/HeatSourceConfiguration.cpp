...
namespace hpwh_data_model  {
	...
	namespace heat_source_configuration  {
		...
		const std::string_view StateOfChargeBasedHeatingLogic::minimum_useful_temperature_units = "K";
		...
		const std::string_view TemperatureBasedHeatingLogic::checks_standby_logic_units = "";

		const std::string_view TemperatureBasedHeatingLogic::checks_standby_logic_description = "Check standby logic for activation";

		const std::string_view TemperatureBasedHeatingLogic::checks_standby_logic_name = "checks_standby_logic";
