...
namespace hpwh_data_model  {
	...
	namespace rscondenserwaterheatsource  {
		...
		void to_json(nlohmann::json& j, const Description& x) {
			json_set<rscondenserwaterheatsource::ProductInformation>(j, "product_information", x.product_information, x.product_information_is_set);
		}
		...
		void to_json(nlohmann::json& j, const GridVariables& x) {
			...
			json_set<std::vector<double>>(j, "heat_source_temperature", x.heat_source_temperature, x.heat_source_temperature_is_set);
		}
		...
		void to_json(nlohmann::json& j, const PerformanceMap& x) {
			json_set<rscondenserwaterheatsource::GridVariables>(j, "grid_variables", x.grid_variables, x.grid_variables_is_set);
			json_set<rscondenserwaterheatsource::LookupVariables>(j, "lookup_variables", x.lookup_variables, x.lookup_variables_is_set);
		}
		...
		void to_json(nlohmann::json& j, const Performance& x) {
			json_set<rscondenserwaterheatsource::PerformanceMap>(j, "performance_map", x.performance_map, x.performance_map_is_set);
			json_set<double>(j, "standby_power", x.standby_power, x.standby_power_is_set);
			json_set<rscondenserwaterheatsource::CoilConfiguration>(j, "coil_configuration", x.coil_configuration, x.coil_configuration_is_set);
		...
		void to_json(nlohmann::json& j, const RSCONDENSERWATERHEATSOURCE& x) {
			...
			json_set<rscondenserwaterheatsource::Description>(j, "description", x.description, x.description_is_set);
			json_set<rscondenserwaterheatsource::Performance>(j, "performance", x.performance, x.performance_is_set);
		}
