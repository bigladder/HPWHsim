...
namespace hpwh_data_model  {
	...
	namespace rsintegratedwaterheater  {
		...
		const std::string_view Rating10CFR430::nominal_tank_volume_units = "gal";

		const std::string_view Rating10CFR430::nominal_tank_volume_description = "Nominal storage capacity of the tank";

		const std::string_view Rating10CFR430::nominal_tank_volume_name = "nominal_tank_volume";

		const std::string_view Rating10CFR430::first_hour_rating_units = "gal/h";
		...
		const std::string_view Rating10CFR430::uniform_energy_factor_description = "Uniform Energy Factor (UEF)";
