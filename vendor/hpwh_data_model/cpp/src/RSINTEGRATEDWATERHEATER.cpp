...
namespace hpwh_data_model  {
	...
	namespace rsintegratedwaterheater  {
		...
		void to_json(nlohmann::json& j, const Description& x) {
			json_set<rsintegratedwaterheater::ProductInformation>(j, logger.get(), "product_information", x.product_information, x.product_information_is_set, false);
		}
		...
		void to_json(nlohmann::json& j, const RSINTEGRATEDWATERHEATER& x) {
			...
			json_set<rsintegratedwaterheater::Description>(j, logger.get(), "description", x.description, x.description_is_set, false);
			json_set<rsintegratedwaterheater::Performance>(j, logger.get(), "performance", x.performance, x.performance_is_set, true);
		}
