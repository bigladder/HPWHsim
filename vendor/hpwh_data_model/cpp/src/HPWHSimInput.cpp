...
namespace hpwh_data_model  {
	...
	namespace hpwh_sim_input  {
		...
		const std::string_view HPWHSimInput::interpolate_cop_units = "";

		const std::string_view HPWHSimInput::interpolate_cop_description = "Performance will be calculated by interpolating COP instead of capacity";

		const std::string_view HPWHSimInput::interpolate_cop_name = "interpolate_cop";
