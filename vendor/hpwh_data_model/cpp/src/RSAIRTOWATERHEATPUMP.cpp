...
namespace hpwh_data_model  {
	...
	namespace rsairtowaterheatpump  {
		...
		void to_json(nlohmann::json& j, const Description& x) {
			json_set<rsairtowaterheatpump::ProductInformation>(j, logger.get(), "product_information", x.product_information, x.product_information_is_set, false);
		}
		...
		void to_json(nlohmann::json& j, const GridVariables& x) {
			...
			json_set<std::vector<double>>(j, logger.get(), "condenser_entering_temperature", x.condenser_entering_temperature, x.condenser_entering_temperature_is_set, true);
			json_set<std::vector<double>>(j, logger.get(), "condenser_leaving_temperature", x.condenser_leaving_temperature, x.condenser_leaving_temperature_is_set, true);
		}
		...
		void to_json(nlohmann::json& j, const PerformanceMap& x) {
			json_set<rsairtowaterheatpump::GridVariables>(j, logger.get(), "grid_variables", x.grid_variables, x.grid_variables_is_set, true);
			json_set<rsairtowaterheatpump::LookupVariables>(j, logger.get(), "lookup_variables", x.lookup_variables, x.lookup_variables_is_set, true);
		}
		...
		void to_json(nlohmann::json& j, const Performance& x) {
			json_set<rsairtowaterheatpump::PerformanceMap>(j, logger.get(), "performance_map", x.performance_map, x.performance_map_is_set, true);
		...
		void to_json(nlohmann::json& j, const RSAIRTOWATERHEATPUMP& x) {
			...
			json_set<rsairtowaterheatpump::Description>(j, logger.get(), "description", x.description, x.description_is_set, false);
			json_set<rsairtowaterheatpump::Performance>(j, logger.get(), "performance", x.performance, x.performance_is_set, true);
		}
