...
namespace hpwh_data_model {
	namespace heat_source_configuration {
		...
		struct TemperatureBasedHeatingLogic : heat_source_configuration::HeatingLogicTemplate {
			...
			const static std::string_view checks_standby_logic_units;
			const static std::string_view checks_standby_logic_description;
			const static std::string_view checks_standby_logic_name;
		};
