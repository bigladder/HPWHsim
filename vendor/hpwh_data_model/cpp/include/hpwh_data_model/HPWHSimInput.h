...
namespace hpwh_data_model {
	namespace hpwh_sim_input {
		...
		struct HPWHSimInput {
			...
			const static std::string_view interpolate_cop_units;
			const static std::string_view interpolate_cop_description;
			const static std::string_view interpolate_cop_name;
		};
