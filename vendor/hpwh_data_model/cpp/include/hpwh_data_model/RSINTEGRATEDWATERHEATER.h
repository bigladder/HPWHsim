...
namespace hpwh_data_model {
	namespace rsintegratedwaterheater {
		...
		struct Rating10CFR430 {
			...
			static constexpr std::string_view nominal_tank_volume_units = "";
			static constexpr std::string_view nominal_tank_volume_description = "Nominal tank volume";
			...
			static constexpr std::string_view first_hour_rating_units = "";
			...
			static constexpr std::string_view uniform_energy_factor_description = "Uniform energy factor";
