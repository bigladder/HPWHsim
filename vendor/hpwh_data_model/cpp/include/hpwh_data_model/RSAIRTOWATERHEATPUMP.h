...
namespace hpwh_data_model {
	namespace rsairtowaterheatpump {
		...
		struct MaximumSetpointAtLowTemperature {
			...
			const static std::string_view threshold_environment_temperature_units;
			const static std::string_view threshold_environment_temperature_description;
			const static std::string_view threshold_environment_temperature_name;
			double maximum_setpoint_temperature;
			bool maximum_setpoint_temperature_is_set = false;
			const static std::string_view maximum_setpoint_temperature_units;
			const static std::string_view maximum_setpoint_temperature_description;
			const static std::string_view maximum_setpoint_temperature_name;
		};
		struct ResistanceElementDefrost {
			...
			const static std::string_view lift_temperature_units;
			const static std::string_view lift_temperature_description;
			const static std::string_view lift_temperature_name;
			double activation_temperature;
			bool activation_temperature_is_set = false;
			const static std::string_view activation_temperature_units;
			const static std::string_view activation_temperature_description;
			const static std::string_view activation_temperature_name;
		};
		struct Description {
		...
		struct Performance {
			...
			const static std::string_view maximum_setpoint_at_low_temperature_units;
			const static std::string_view maximum_setpoint_at_low_temperature_description;
			const static std::string_view maximum_setpoint_at_low_temperature_name;
			rsairtowaterheatpump::ResistanceElementDefrost resistance_element_defrost;
			bool resistance_element_defrost_is_set = false;
			const static std::string_view resistance_element_defrost_units;
			const static std::string_view resistance_element_defrost_description;
			const static std::string_view resistance_element_defrost_name;
		};
