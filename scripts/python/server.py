...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        if self.path.startswith('/test_and_plot'):
            ...
            result = do_test_and_plot(model_spec, model_name, test_name, plot_name, measurements_name)
            ...
            result = do_measure(model_spec, model_name)
...
def do_measure(model_spec, model_name):
    return main.call_measure(model_spec, model_name)
