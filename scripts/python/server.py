...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        if self.path.startswith('/test_and_plot'):
            ...
            result = test_and_plot(model_spec, model_name, test_name, plot_name, measurements_name)
...
def test_and_plot(model_spec, model_name, test_name, plot_name, measurements_name):
