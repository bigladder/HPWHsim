...
class TestPlotter:
	...
	def analyze(self, data_set):		
		...
		data_set.test_summary['first-recovery-period'] = recovery_summary
		data_set.test_summary['standby-period'] = standby_summary		
