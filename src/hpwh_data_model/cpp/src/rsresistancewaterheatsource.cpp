...
namespace hpwh_data_model  {
	...
	namespace rsresistancewaterheatsource_ns  {
		...
		void from_json(const nlohmann::json& j, Performance& x) {
			...
			json_get<double>(j, logger.get(), "resistance_lockout_temperature_hysteresis", x.resistance_lockout_temperature_hysteresis, x.resistance_lockout_temperature_hysteresis_is_set, false);
		}
		const std::string_view Performance::input_power_units = "W";

		const std::string_view Performance::resistance_lockout_temperature_hysteresis_units = "K";

		const std::string_view Performance::input_power_description = "Input power";

		const std::string_view Performance::resistance_lockout_temperature_hysteresis_description = "Hysteresis for resistance lockout";

		const std::string_view Performance::input_power_name = "input_power";

		const std::string_view Performance::resistance_lockout_temperature_hysteresis_name = "resistance_lockout_temperature_hysteresis";
