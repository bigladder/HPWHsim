...
namespace hpwh_data_model  {
	...
	namespace rsresistancewaterheatsource_ns  {
		...
		void from_json(const nlohmann::json& j, ProductInformation& x) {
			json_get<std::string>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "manufacturer", x.manufacturer, x.manufacturer_is_set, true);
			json_get<std::string>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "model_number", x.model_number, x.model_number_is_set, true);
		}
		...
		void from_json(const nlohmann::json& j, Description& x) {
			json_get<rsresistancewaterheatsource_ns::ProductInformation>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "product_information", x.product_information, x.product_information_is_set, false);
		}
		...
		void from_json(const nlohmann::json& j, Performance& x) {
			json_get<double>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "input_power", x.input_power, x.input_power_is_set, true);
		}
		...
		void from_json(const nlohmann::json& j, RSRESISTANCEWATERHEATSOURCE& x) {
			json_get<core_ns::Metadata>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "metadata", x.metadata, x.metadata_is_set, true);
			json_get<rsresistancewaterheatsource_ns::Description>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "description", x.description, x.description_is_set, false);
			json_get<rsresistancewaterheatsource_ns::Performance>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "performance", x.performance, x.performance_is_set, true);
		}
        ...
        void RSRESISTANCEWATERHEATSOURCE::initialize(const nlohmann::json& j) {
            json_get<core_ns::Metadata>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "metadata", metadata, metadata_is_set, true);
            json_get<Description>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "description", description, description_is_set, false);
            json_get<Performance>(j, *RSRESISTANCEWATERHEATSOURCE::logger, "performance", performance, performance_is_set, true);
        }
	}
}
