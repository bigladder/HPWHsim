...
namespace hpwh_data_model  {
	...
	namespace rsresistancewaterheatsource_ns  {
		...
		void from_json(const nlohmann::json& j, Description& x) {
			json_get<rsresistancewaterheatsource_ns::ProductInformation>(j, "product_information", x.product_information, x.product_information_is_set, false);
		}
		...
		void from_json(const nlohmann::json& j, RSRESISTANCEWATERHEATSOURCE& x) {
			...
			json_get<rsresistancewaterheatsource_ns::Description>(j, "description", x.description, x.description_is_set, false);
			json_get<rsresistancewaterheatsource_ns::Performance>(j, "performance", x.performance, x.performance_is_set, true);
		}
