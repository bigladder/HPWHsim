...
const static std::unordered_map<HeatSourceCoilConfiguration, enum_info>
    HeatSourceCoilConfiguration_info {
        {HeatSourceCoilConfiguration::SUBMERGED,
         {"SUBMERGED", "Submerged", "Heat sources with submerged coil configuration"}},
        {HeatSourceCoilConfiguration::WRAPPED,
         {"WRAPPED", "Wrapped", "Heat sources with wrapped coil configuration"}},
        {HeatSourceCoilConfiguration::EXTERNAL,
         {"EXTERNAL", "External", "Heat sources with external coil configuration"}},
