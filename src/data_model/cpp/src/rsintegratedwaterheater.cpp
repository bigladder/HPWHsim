...
void from_json(const nlohmann::json& j, HeatingLogic& x)
{
    ...
    json_get<std::string>(j, logger.get(), "label", x.label, x.label_is_set, false);
}
...
const std::string_view HeatingLogic::label_units = "";
...
const std::string_view HeatingLogic::label_description = "Identifier for defined heating logic";
...
const std::string_view HeatingLogic::label_name = "label";
...
void from_json(const nlohmann::json& j, HeatSourceConfiguration& x)
{
    ...
    json_get<double>(
        j, logger.get(), "maximum_setpoint", x.maximum_setpoint, x.maximum_setpoint_is_set, false);
    json_get<double>(j,
                     logger.get(),
                     "maximum_temperature",
    ...
    json_get<std::string>(j,
                          ...
                          x.backup_heat_source_label,
                          x.backup_heat_source_label_is_set,
                          false);
    json_get<std::string>(j,
                          logger.get(),
                          "followed_by_heat_source_label",
                          x.followed_by_heat_source_label,
                          x.followed_by_heat_source_label_is_set,
                          false);
    json_get<std::string>(j,
                          logger.get(),
                          "companion_heat_source_label",
                          x.companion_heat_source_label,
                          x.companion_heat_source_label_is_set,
                          false);
}
...
const std::string_view HeatSourceConfiguration::backup_heat_source_label_description =
    "Identifier of backup heat source";

const std::string_view HeatSourceConfiguration::followed_by_heat_source_label_description =
    "Identifier of heat source that follows";

const std::string_view HeatSourceConfiguration::companion_heat_source_label_description =
    "Identifier of companion heat source";
...
const std::string_view HeatSourceConfiguration::backup_heat_source_label_name =
    "backup_heat_source_label";

const std::string_view HeatSourceConfiguration::followed_by_heat_source_label_name =
    "followed_by_heat_source_label";

const std::string_view HeatSourceConfiguration::companion_heat_source_label_name =
    "companion_heat_source_label";
...
const std::string_view TempBasedHeatingLogic::tank_node_specification_description =
...
const std::string_view TempBasedHeatingLogic::activates_standby_description =
    "Applies standby logic.";
...
const std::string_view TempBasedHeatingLogic::tank_node_specification_name =
    "tank_node_specification";
