...
namespace data_model  {
	...
	namespace rscondenserwaterheatsource_ns  {
		...
		void from_json(const nlohmann::json& j, Description& x) {
			json_get<rscondenserwaterheatsource_ns::ProductInformation>(j, logger.get(), "product_information", x.product_information, x.product_information_is_set, false);
		}
		...
		void from_json(const nlohmann::json& j, PerformancePoint& x) {
			json_get<double>(j, logger.get(), "heat_source_temperature", x.heat_source_temperature, x.heat_source_temperature_is_set, true);
			json_get<std::vector<double>>(j, logger.get(), "input_power_coefficients", x.input_power_coefficients, x.input_power_coefficients_is_set, true);
			json_get<std::vector<double>>(j, logger.get(), "cop_coefficients", x.cop_coefficients, x.cop_coefficients_is_set, true);
		}
		...
		void from_json(const nlohmann::json& j, GridVariables& x) {
			json_get<std::vector<double>>(j, logger.get(), "evaporator_environment_temperature", x.evaporator_environment_temperature, x.evaporator_environment_temperature_is_set, true);
		...
		void from_json(const nlohmann::json& j, PerformanceMap& x) {
			json_get<rscondenserwaterheatsource_ns::GridVariables>(j, logger.get(), "grid_variables", x.grid_variables, x.grid_variables_is_set, true);
			json_get<rscondenserwaterheatsource_ns::LookupVariables>(j, logger.get(), "lookup_variables", x.lookup_variables, x.lookup_variables_is_set, true);
		}
		...
		void from_json(const nlohmann::json& j, Performance& x) {
			json_get<std::vector<rscondenserwaterheatsource_ns::PerformancePoint>>(j, logger.get(), "performance_points", x.performance_points, x.performance_points_is_set, true);
			json_get<rscondenserwaterheatsource_ns::PerformanceMap>(j, logger.get(), "performance_map", x.performance_map, x.performance_map_is_set, true);
			json_get<double>(j, logger.get(), "standby_power", x.standby_power, x.standby_power_is_set, false);
			json_get<rscondenserwaterheatsource_ns::CoilConfiguration>(j, logger.get(), "coil_configuration", x.coil_configuration, x.coil_configuration_is_set, true);
		...
		void from_json(const nlohmann::json& j, RSCONDENSERWATERHEATSOURCE& x) {
			...
			json_get<rscondenserwaterheatsource_ns::Description>(j, logger.get(), "description", x.description, x.description_is_set, false);
