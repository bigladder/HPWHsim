...
namespace hpwh_data_model  {
	...
	namespace rsintegratedwaterheater_ns  {
        ...
        void from_json(const nlohmann::json& j, ProductInformation& x) {
			json_get<std::string>(j, *RSINTEGRATEDWATERHEATER::logger, "manufacturer", x.manufacturer, x.manufacturer_is_set, true);
			json_get<std::string>(j, *RSINTEGRATEDWATERHEATER::logger, "model_number", x.model_number, x.model_number_is_set, true);
		}
		...
		void from_json(const nlohmann::json& j, Description& x) {
			json_get<rsintegratedwaterheater_ns::ProductInformation>(j, *RSINTEGRATEDWATERHEATER::logger, "product_information", x.product_information, x.product_information_is_set, false);
		}
		...
		void from_json(const nlohmann::json& j, Performance& x) {
			json_get<rstank_ns::RSTANK>(j, *RSINTEGRATEDWATERHEATER::logger, "tank", x.tank, x.tank_is_set, true);
			json_get<HeatSourceConfiguration>(j, *RSINTEGRATEDWATERHEATER::logger, "heat_source_configurations", x.heatSourceConfiguration, x.heat_source_configurations_is_set, false);
			json_get<int>(j, *RSINTEGRATEDWATERHEATER::logger, "number_of_nodes", x.number_of_nodes, x.number_of_nodes_is_set, false);
			json_get<double>(j, *RSINTEGRATEDWATERHEATER::logger, "standby_power", x.standby_power, x.standby_power_is_set, false);
		}
		...
		const std::string_view Performance::number_of_nodes_description = "Number of nodes used for simulation (temporary)";
		...
		void from_json(const nlohmann::json& j, RSINTEGRATEDWATERHEATER& x) {
			json_get<core_ns::Metadata>(j, *RSINTEGRATEDWATERHEATER::logger, "metadata", x.metadata, x.metadata_is_set, true);
			json_get<rsintegratedwaterheater_ns::Description>(j, *RSINTEGRATEDWATERHEATER::logger, "description", x.description, x.description_is_set, false);
			json_get<rsintegratedwaterheater_ns::Performance>(j, *RSINTEGRATEDWATERHEATER::logger, "performance", x.performance, x.performance_is_set, true);
			json_get<double>(j, *RSINTEGRATEDWATERHEATER::logger, "standby_power", x.standby_power, x.standby_power_is_set, false);
		}
		...
		void from_json(const nlohmann::json& j, HeatingLogic& x) {
			json_get<double>(j, *RSINTEGRATEDWATERHEATER::logger, "absolute_temperature", x.absolute_temperature, x.absolute_temperature_is_set, true);
			json_get<double>(j, *RSINTEGRATEDWATERHEATER::logger, "differential_temperature", x.differential_temperature, x.differential_temperature_is_set, true);
			json_get<std::vector<double>>(j, *RSINTEGRATEDWATERHEATER::logger, "logic_distribution", x.logic_distribution, x.logic_distribution_is_set, true);
			json_get<rsintegratedwaterheater_ns::ComparisonType>(j, *RSINTEGRATEDWATERHEATER::logger, "comparison_type", x.comparison_type, x.comparison_type_is_set, true);
			json_get<double>(j, *RSINTEGRATEDWATERHEATER::logger, "hysteresis_temperature", x.hysteresis_temperature, x.hysteresis_temperature_is_set, false);
		}
		...
		void from_json(const nlohmann::json& j, HeatSourceConfiguration& x) {
    		json_get<rsintegratedwaterheater_ns::HeatSourceType>(j, *RSINTEGRATEDWATERHEATER::logger, "heat_source_type", x.heat_source_type, x.heat_source_type_is_set, true);
			...
			json_get<std::vector<double>>(j, *RSINTEGRATEDWATERHEATER::logger, "heat_distribution", x.heat_distribution, x.heat_distribution_is_set, true);
			json_get<std::vector<rsintegratedwaterheater_ns::HeatingLogic>>(j, *RSINTEGRATEDWATERHEATER::logger, "turn_on_logic", x.turn_on_logic, x.turn_on_logic_is_set, true);
			json_get<std::vector<rsintegratedwaterheater_ns::HeatingLogic>>(j, *RSINTEGRATEDWATERHEATER::logger, "shut_off_logic", x.shut_off_logic, x.shut_off_logic_is_set, false);
			json_get<std::vector<rsintegratedwaterheater_ns::HeatingLogic>>(j, *RSINTEGRATEDWATERHEATER::logger, "standby_logic", x.standby_logic, x.standby_logic_is_set, false);
			json_get<double>(j, *RSINTEGRATEDWATERHEATER::logger, "maximum_setpoint", x.maximum_setpoint, x.maximum_setpoint_is_set, false);
		}
        ...
        void RSINTEGRATEDWATERHEATER::initialize(const nlohmann::json& j) {
            json_get<core_ns::Metadata>(j, *RSINTEGRATEDWATERHEATER::logger, "metadata", metadata, metadata_is_set, true);
            json_get<Description>(j, *RSINTEGRATEDWATERHEATER::logger, "description", description, description_is_set, false);
            json_get<Performance>(j, *RSINTEGRATEDWATERHEATER::logger, "performance", performance, performance_is_set, true);
        }
	}
}
