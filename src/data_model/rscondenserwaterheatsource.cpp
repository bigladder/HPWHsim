...
void from_json(const nlohmann::json& j, Description& x) {
    json_get<rscondenserwaterheatsource_ns::ProductInformation>(j, "product_information", x.product_information, x.product_information_is_set, false);
}
...
void from_json(const nlohmann::json& j, PerformancePoint& x) {
    json_get<double>(j, "heat_source_temperature", x.heat_source_temperature, x.heat_source_temperature_is_set, true);
    json_get<std::vector<double>>(j, "input_power_coefficients", x.input_power_coefficients, x.input_power_coefficients_is_set, true);
    json_get<std::vector<double>>(j, "cop_coefficients", x.cop_coefficients, x.cop_coefficients_is_set, true);
}
...
const std::string_view PerformancePoint::heat_source_temperature_description = "Temperature of heat source";

const std::string_view PerformancePoint::input_power_coefficients_description = "Input-power polynomial expansion coefficients";

const std::string_view PerformancePoint::cop_coefficients_description = "Coefficient-of-performance expansion coefficients";
...
void from_json(const nlohmann::json& j, GridVariables& x) {
    json_get<std::vector<double>>(j, "evaporator_environment_temperature", x.evaporator_environment_temperature, x.evaporator_environment_temperature_is_set, true);
    json_get<std::vector<double>>(j, "heat_source_temperature", x.heat_source_temperature, x.heat_source_temperature_is_set, true);
}
...
const std::string_view LookupVariables::input_power_description = "Input power (Nevap x Nsrc values)";

const std::string_view LookupVariables::cop_description = "Coefficient of performance (Nevap x Nsrc values)";
...
void from_json(const nlohmann::json& j, PerformanceMap& x) {
    json_get<rscondenserwaterheatsource_ns::GridVariables>(j, "grid_variables", x.grid_variables, x.grid_variables_is_set, true);
    json_get<rscondenserwaterheatsource_ns::LookupVariables>(j, "lookup_variables", x.lookup_variables, x.lookup_variables_is_set, true);
}
...
void from_json(const nlohmann::json& j, Performance& x) {
    json_get<std::vector<rscondenserwaterheatsource_ns::PerformancePoint>>(j, "performance_points", x.performance_points, x.performance_points_is_set, true);
    json_get<rscondenserwaterheatsource_ns::PerformanceMap>(j, "performance_map", x.performance_map, x.performance_map_is_set, true);
    json_get<double>(j, "standby_power", x.standby_power, x.standby_power_is_set, false);
    json_get<rscondenserwaterheatsource_ns::CoilConfiguration>(j, "coil_configuration", x.coil_configuration, x.coil_configuration_is_set, true);
    json_get<bool>(j, "use_defrost_map", x.use_defrost_map, x.use_defrost_map_is_set, false);
}
...
const std::string_view Performance::performance_points_description = "Collection of performance points";
...
void from_json(const nlohmann::json& j, RSCONDENSERWATERHEATSOURCE& x) {
    ...
    json_get<rscondenserwaterheatsource_ns::Description>(j, "description", x.description, x.description_is_set, false);
    json_get<rscondenserwaterheatsource_ns::Performance>(j, "performance", x.performance, x.performance_is_set, true);
}
