...
namespace hpwh_data_model  {
	...
	namespace rscondenserwaterheatsource_ns  {
		...
		void from_json(const nlohmann::json& j, ProductInformation& x) {
			json_get<std::string>(j, *RSCONDENSERWATERHEATSOURCE::logger, "manufacturer", x.manufacturer, x.manufacturer_is_set, true);
			json_get<std::string>(j, *RSCONDENSERWATERHEATSOURCE::logger, "model_number", x.model_number, x.model_number_is_set, true);
		}
		...
		void from_json(const nlohmann::json& j, Description& x) {
			json_get<rscondenserwaterheatsource_ns::ProductInformation>(j, *RSCONDENSERWATERHEATSOURCE::logger, "product_information", x.product_information, x.product_information_is_set, false);
		}
		...
		void from_json(const nlohmann::json& j, GridVariables& x) {
			json_get<std::vector<double>>(j, *RSCONDENSERWATERHEATSOURCE::logger, "evaporator_environment_temperature", x.evaporator_environment_temperature, x.evaporator_environment_temperature_is_set, true);
			json_get<std::vector<double>>(j, *RSCONDENSERWATERHEATSOURCE::logger, "heat_source_temperature", x.heat_source_temperature, x.heat_source_temperature_is_set, true);
		}
		...
		const std::string_view GridVariables::evaporator_environment_temperature_description = "Evaporator environment temperatures (Nevap values)";

		const std::string_view GridVariables::heat_source_temperature_description = "Temperature of heat sources (Nsrc values)";

		const std::string_view GridVariables::evaporator_environment_temperature_name = "evaporator_environment_temperature";
		...
		void from_json(const nlohmann::json& j, LookupVariables& x) {
			json_get<std::vector<double>>(j, *RSCONDENSERWATERHEATSOURCE::logger, "input_power", x.input_power, x.input_power_is_set, true);
			json_get<std::vector<double>>(j, *RSCONDENSERWATERHEATSOURCE::logger, "cop", x.cop, x.cop_is_set, true);
		}
		const std::string_view LookupVariables::input_power_units = "W";

		const std::string_view LookupVariables::cop_units = "-";

		const std::string_view LookupVariables::input_power_description = "Input power - Contains Nevap x Nsrc values";

		const std::string_view LookupVariables::cop_description = "Coefficient of performance - Contains Nevap x Nsrc values";
		...
		void from_json(const nlohmann::json& j, PerformanceMap& x) {
			json_get<rscondenserwaterheatsource_ns::GridVariables>(j, *RSCONDENSERWATERHEATSOURCE::logger, "grid_variables", x.grid_variables, x.grid_variables_is_set, true);
			json_get<rscondenserwaterheatsource_ns::LookupVariables>(j, *RSCONDENSERWATERHEATSOURCE::logger, "lookup_variables", x.lookup_variables, x.lookup_variables_is_set, true);
		}
		const std::string_view PerformanceMap::grid_variables_units = "";

		const std::string_view PerformanceMap::lookup_variables_units = "";

		const std::string_view PerformanceMap::grid_variables_description = "Collection of values affecting performance.";

		const std::string_view PerformanceMap::lookup_variables_description = "Collection of performance metrics.";
		...
		void from_json(const nlohmann::json& j, Performance& x) {
			json_get<rscondenserwaterheatsource_ns::PerformanceMap>(j, *RSCONDENSERWATERHEATSOURCE::logger, "performance_map", x.performance_map, x.performance_map_is_set, true);
			json_get<double>(j, *RSCONDENSERWATERHEATSOURCE::logger, "standby_power", x.standby_power, x.standby_power_is_set, false);
			json_get<rscondenserwaterheatsource_ns::CoilConfiguration>(j, *RSCONDENSERWATERHEATSOURCE::logger, "coil_configuration", x.coil_configuration, x.coil_configuration_is_set, true);
		}
		...
		const std::string_view Performance::performance_map_description = "Collection of performance values";
		...
		void from_json(const nlohmann::json& j, RSCONDENSERWATERHEATSOURCE& x) {
			json_get<core_ns::Metadata>(j, *RSCONDENSERWATERHEATSOURCE::logger, "metadata", x.metadata, x.metadata_is_set, true);
			json_get<rscondenserwaterheatsource_ns::Description>(j, *RSCONDENSERWATERHEATSOURCE::logger, "description", x.description, x.description_is_set, false);
			json_get<rscondenserwaterheatsource_ns::Performance>(j, *RSCONDENSERWATERHEATSOURCE::logger, "performance", x.performance, x.performance_is_set, true);
		}
        ...
        void RSCONDENSERWATERHEATSOURCE::initialize(const nlohmann::json& j) {
            json_get<core_ns::Metadata>(j, *RSCONDENSERWATERHEATSOURCE::logger, "metadata", metadata, metadata_is_set, true);
            json_get<Description>(j, *RSCONDENSERWATERHEATSOURCE::logger, "description", description, description_is_set, false);
            json_get<Performance>(j, *RSCONDENSERWATERHEATSOURCE::logger, "performance", performance, performance_is_set, true);
        }
	}
}
