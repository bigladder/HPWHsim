...
void measure(const std::string& sSpecType,
             ...
             std::string sCustomDrawProfile)
             {
                 ...
                 {
                     sPresetOrFile[0] = static_cast<char>(
                         std::toupper(static_cast<unsigned char>(sPresetOrFile[0])));
                 }
                 ...
                 if (useCustomDrawProfile)
                 {
                     ...
                     {
                         sCustomDrawProfile[0] = static_cast<char>(
                             std::toupper(static_cast<unsigned char>(sCustomDrawProfile[0])));
                     }
