...
template <typename T>
static void autofill_metadata(nlohmann::json& j)
{
    j["schema_author"] = "Big Ladder Software, LLC";
    j["author"] = "California Energy Commission";
    j["description"] = "Representation of embedded HPWH element";
    j["source"] = "Generated by HPWHsim";
...
void HPWH::productInformation_to_json(const RSTYPE& rs, nlohmann::json& j)
{
...
/*static*/
void HPWH::rating10CFR430_to_json(
    ...
    nlohmann::json& j)
{
    if (rswh.description_is_set)
    {
        ...
        {
            nlohmann::json j_rating_10_cfr_430 = {};
            auto& rating_10_cfr_430 = desc.rating_10_cfr_430;
            if (rating_10_cfr_430.certified_reference_number_is_set)
                j_rating_10_cfr_430["certified_reference_number"] =
                    rating_10_cfr_430.certified_reference_number;
            if (rating_10_cfr_430.nominal_tank_volume_is_set)
                j_rating_10_cfr_430["nominal_tank_volume"] = rating_10_cfr_430.nominal_tank_volume;
            if (rating_10_cfr_430.first_hour_rating_is_set)
                j_rating_10_cfr_430["first_hour_rating"] = rating_10_cfr_430.first_hour_rating;
            if (rating_10_cfr_430.recovery_efficiency_is_set)
                j_rating_10_cfr_430["recovery_efficiency"] = rating_10_cfr_430.recovery_efficiency;
            if (rating_10_cfr_430.uniform_energy_factor_is_set)
                j_rating_10_cfr_430["uniform_energy_factor"] =
                    rating_10_cfr_430.uniform_energy_factor;

            if (!j_rating_10_cfr_430.empty())
            {
                if (!j.contains("description"))
                    j["description"] = {};
                j["description"]["rating_10_cfr_430"] = j_rating_10_cfr_430;
            }
        }
    }
}
                   ...
                   nlohmann::json& j)
{
    ...
    autofill_metadata<hpwh_data_model::rsintegratedwaterheater::Schema>(j_metadata);
    j_metadata["schema_name"] = "RSINTEGRATEDWATERHEATER";
...
/*static*/
void HPWH::to_json(const hpwh_data_model::rstank::RSTANK& rstank, nlohmann::json& j)
{
    nlohmann::json j_metadata;
    autofill_metadata<hpwh_data_model::rstank::Schema>(j_metadata);
    j_metadata["schema_name"] = "RSTANK";
...
{
    nlohmann::json j_metadata;
    autofill_metadata<hpwh_data_model::rscondenserwaterheatsource::Schema>(j_metadata);
    j_metadata["schema_name"] = "RSCONDENSERWATERHEATSOURCE";
    j_metadata["schema_url"] = "https://github.com/bigladder/hpwh-data-model/blob/main/schema/"
...
/*static*/
void HPWH::to_json(const hpwh_data_model::rsairtowaterheatpump::RSAIRTOWATERHEATPUMP& rshs,
                   nlohmann::json& j)
{
    nlohmann::json j_metadata;
    autofill_metadata<hpwh_data_model::rsairtowaterheatpump::Schema>(j_metadata);
    j_metadata["schema_name"] = "RSAIRTOWATERHEATPUMP";
    j_metadata["schema_url"] = "https://github.com/bigladder/hpwh-data-model/blob/main/schema/"
...
{
    nlohmann::json j_metadata;
    autofill_metadata<hpwh_data_model::rsresistancewaterheatsource::Schema>(j_metadata);
    j_metadata["schema_name"] = "RSRESISTANCEWATERHEATSOURCE";
    j_metadata["schema_url"] = "https://github.com/bigladder/hpwh-data-model/blob/main/schema/"
    ...
    nlohmann::json& j)
{
    ...
    if (tempLogic.standby_temperature_location_is_set)
    {
        ...
        {
        case hpwh_data_model::heat_source_configuration::StandbyTemperatureLocation::TOP_OF_TANK:
        {
            j["standby_temperature_location"] = "TOP_OF_TANK";
            break;
        }
        case hpwh_data_model::heat_source_configuration::StandbyTemperatureLocation::BOTTOM_OF_TANK:
        {
...
/*static*/
void HPWH::to_json(const hpwh_data_model::heat_source_configuration::HeatingLogic& heating_logic,
                   nlohmann::json& j)
{
    ...
    if (heating_logic.heating_logic_type_is_set)
    {
        ...
        case hpwh_data_model::heat_source_configuration::HeatingLogicType::UNKNOWN:
            break;
        }
    }
}
