...
const std::string_view Schema::schema_description =
    "Schema for ASHRAE 205 annex RSAIRTOWATERHEATPUMP: Air-to-Water Heat Pump";
...
{
    json_get<rsairtowaterheatpump::ProductInformation>(j,
                                                       logger.get(),
                                                       "product_information",
...
{
    json_get<rsairtowaterheatpump::GridVariables>(
        j, logger.get(), "grid_variables", x.grid_variables, x.grid_variables_is_set, true);
    json_get<rsairtowaterheatpump::LookupVariables>(
...
{
    json_get<rsairtowaterheatpump::PerformanceMap>(
...
void from_json(const nlohmann::json& j, RSAIRTOWATERHEATPUMP& x)
{
    ...
    json_get<rsairtowaterheatpump::Description>(
        j, logger.get(), "description", x.description, x.description_is_set, false);
    json_get<rsairtowaterheatpump::Performance>(
...
const std::string_view RSAIRTOWATERHEATPUMP::description_description =
...
const std::string_view RSAIRTOWATERHEATPUMP::performance_description =
