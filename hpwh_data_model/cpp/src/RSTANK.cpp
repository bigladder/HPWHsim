...
const std::string_view Schema::schema_description =
    "Schema for ASHRAE 205 annex RSTANK: Water tank";
...
{
    json_get<rstank::ProductInformation>(j,
                                         logger.get(),
                                         "product_information",
...
void from_json(const nlohmann::json& j, Performance& x)
{
    ...
    json_get<double>(j,
                     ...
                     x.heat_exchanger_effectiveness,
                     x.heat_exchanger_effectiveness_is_set,
                     false);
}
...
const std::string_view Performance::bottom_fraction_of_tank_mixing_on_draw_description =
    "Bottom fraction of the tank that should mix during draws";
...
const std::string_view Performance::heat_exchanger_effectiveness_description =
    "Effectiveness for heat exchange";

const std::string_view Performance::heat_exchanger_effectiveness_name =
    "heat_exchanger_effectiveness";
...
const std::string_view RSTANK::description_description =
...
const std::string_view RSTANK::performance_description =
