...
void from_json(const nlohmann::json& j, GridVariables& x) {
    ...
    json_get<std::vector<double>>(j, logger.get(), "outlet_temperature", x.outlet_temperature, x.outlet_temperature_is_set, false);
}
...
const std::string_view GridVariables::outlet_temperature_description = "Outlet temperature used by single-pass central water-heating systems";
...
void from_json(const nlohmann::json& j, Performance& x) {
    ...
    json_get<rscondenserwaterheatsource_ns::SecondaryHeatExchanger>(j, logger.get(), "secondary_heat_exchanger", x.secondary_heat_exchanger, x.secondary_heat_exchanger_is_set, false);
}
...
const std::string_view Performance::maximum_temperature_description = "Maximum external temperature";

const std::string_view Performance::minimum_temperature_description = "Minimum external temperature";
...
const std::string_view Performance::secondary_heat_exchanger_description = "Secondary heat exchanger";
