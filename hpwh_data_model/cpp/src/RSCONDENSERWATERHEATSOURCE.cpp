...
{
    json_get<rscondenserwaterheatsource::ProductInformation>(j,
                                                             logger.get(),
                                                             "product_information",
...
{
    json_get<rscondenserwaterheatsource::GridVariables>(
        j, logger.get(), "grid_variables", x.grid_variables, x.grid_variables_is_set, true);
    json_get<rscondenserwaterheatsource::LookupVariables>(
...
{
    json_get<rscondenserwaterheatsource::PerformanceMap>(
    ...
    json_get<rscondenserwaterheatsource::CoilConfiguration>(j,
                                                            logger.get(),
                                                            "coil_configuration",
...
void from_json(const nlohmann::json& j, RSCONDENSERWATERHEATSOURCE& x)
{
    ...
    json_get<rscondenserwaterheatsource::Description>(
        j, logger.get(), "description", x.description, x.description_is_set, false);
    json_get<rscondenserwaterheatsource::Performance>(
