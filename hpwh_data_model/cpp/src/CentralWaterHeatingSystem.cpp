...
const std::string_view Schema::schema_description =
    "Components that make up a central water heating system";
...
void from_json(const nlohmann::json& j, CentralWaterHeatingSystem& x)
{
    ...
    json_get<double>(j,
                     ...
                     x.external_inlet_height_is_set,
                     false);
    json_get<double>(j,
                     logger.get(),
                     "external_outlet_height",
                     x.external_outlet_height,
                     x.external_outlet_height_is_set,
                     false);
    json_get<central_water_heating_system::ControlType>(
        j, logger.get(), "control_type", x.control_type, x.control_type_is_set, true);
    json_get<double>(
        j, logger.get(), "fixed_flow_rate", x.fixed_flow_rate, x.fixed_flow_rate_is_set, true);
    json_get<double>(j,
                     logger.get(),
                     "fixed_outlet_temperature",
                     x.fixed_outlet_temperature,
                     x.fixed_outlet_temperature_is_set,
                     true);
    json_get<central_water_heating_system::SecondaryHeatExchanger>(
        j,
        logger.get(),
...
const std::string_view CentralWaterHeatingSystem::tank_description =
...
const std::string_view CentralWaterHeatingSystem::heat_source_configurations_description =
    "Describes how the heat sources are configured within the tank";

const std::string_view CentralWaterHeatingSystem::heat_source_configurations_name =
    "heat_source_configurations";

const std::string_view CentralWaterHeatingSystem::primary_heat_source_id_units = "";

const std::string_view CentralWaterHeatingSystem::primary_heat_source_id_description =
    "Turns on independently of other heat sources";

const std::string_view CentralWaterHeatingSystem::primary_heat_source_id_name =
    "primary_heat_source_id";

const std::string_view CentralWaterHeatingSystem::standby_power_units = "";

const std::string_view CentralWaterHeatingSystem::standby_power_description =
...
const std::string_view CentralWaterHeatingSystem::external_inlet_height_description =
    "Fractional tank height of inlet";

const std::string_view CentralWaterHeatingSystem::external_inlet_height_name =
    "external_inlet_height";

const std::string_view CentralWaterHeatingSystem::external_outlet_height_units = "";

const std::string_view CentralWaterHeatingSystem::external_outlet_height_description =
    "Fractional tank height of outlet";

const std::string_view CentralWaterHeatingSystem::external_outlet_height_name =
    "external_outlet_height";
...
const std::string_view CentralWaterHeatingSystem::fixed_flow_rate_description =
    "Flow rate, if multipass system";
...
const std::string_view CentralWaterHeatingSystem::fixed_outlet_temperature_description =
    "Fixed Outlet Temperature";

const std::string_view CentralWaterHeatingSystem::fixed_outlet_temperature_name =
    "fixed_outlet_temperature";

const std::string_view CentralWaterHeatingSystem::secondary_heat_exchanger_units = "";

const std::string_view CentralWaterHeatingSystem::secondary_heat_exchanger_description =
    "Secondary heat exchanger";

const std::string_view CentralWaterHeatingSystem::secondary_heat_exchanger_name =
    "secondary_heat_exchanger";
