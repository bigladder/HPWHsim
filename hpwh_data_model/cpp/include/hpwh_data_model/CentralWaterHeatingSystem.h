...
const static std::unordered_map<ControlType, enum_info> ControlType_info {
    ...
    {ControlType::FIXED_OUTLET_TEMPERATURE,
     {"FIXED_OUTLET_TEMPERATURE", "FIXED_OUTLET_TEMPERATURE", "Fixed Outlet Temperature"}},
