...
const static std::unordered_map<SchemaType, enum_info> SchemaType_info {
    ...
    {SchemaType::RSAIRTOWATERHEATPUMP,
     {"RSAIRTOWATERHEATPUMP", "RSAIRTOWATERHEATPUMP", "Air-to-Water Heat Pump"}},
    {SchemaType::HPWHSIMINPUT,
     {"HPWHSIMINPUT",
      "HPWHSIMINPUT",
...
{
    virtual ~RepresentationSpecificationTemplate();
};
