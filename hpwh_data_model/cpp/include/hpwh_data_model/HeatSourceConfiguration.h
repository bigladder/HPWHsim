...
const static std::unordered_map<HeatSourceType, enum_info> HeatSourceType_info {
    ...
    {HeatSourceType::AIRTOWATERHEATPUMP,
     {"AIRTOWATERHEATPUMP",
      "AirToWaterHeatPump",
      "Heat sources that operate by air-to-water heat pump systems"}},
...
const static std::unordered_map<StandbyTemperatureLocation, enum_info>
    StandbyTemperatureLocation_info {
        {StandbyTemperatureLocation::TOP_OF_TANK,
         {"TOP_OF_TANK", "Top of tank", "Refers to top of tank."}},
        {StandbyTemperatureLocation::BOTTOM_OF_TANK,
         {"BOTTOM_OF_TANK", "Bottom of tank", "Refers to bottom of tank."}},
