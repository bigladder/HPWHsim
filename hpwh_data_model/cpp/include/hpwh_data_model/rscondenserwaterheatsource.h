...
struct GridVariables {
    ...
    bool evaporator_environment_dry_bulb_temperature_is_set;
    bool heat_source_temperature_is_set;
    bool outlet_temperature_is_set;
    ...
    const static std::string_view outlet_temperature_units;
    ...
    const static std::string_view outlet_temperature_description;
...
struct SecondaryHeatExchanger {
    ...
    bool cold_side_temperature_offset_is_set;
    bool hot_side_temperature_offset_is_set;
    bool extra_pump_power_is_set;
...
struct Performance {
    ...
    rscondenserwaterheatsource_ns::SecondaryHeatExchanger secondary_heat_exchanger;
    bool performance_map_is_set;
    bool standby_power_is_set;
    bool coil_configuration_is_set;
    bool maximum_refrigerant_temperature_is_set;
    bool maximum_temperature_is_set;
    bool minimum_temperature_is_set;
    bool compressor_lockout_temperature_hysteresis_is_set;
